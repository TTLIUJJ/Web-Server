...
import xmu.ackerman.http.service.ResponseService;
import xmu.ackerman.spring.mvc.DispatcherServlet;
...
public class WriteThread implements Runnable {
    ...
    private static DispatcherServlet dispatcherServlet = DispatcherServlet.getDispatcherServlet();
...
//            ResponseService.write(context);
            ...
            dispatcherServlet.complexProcess(context);

            ResponseService.write2(context);
